...
> **想要更丰富的演示数据？** 跑 `docker exec course-selection-app python seed_full_demo.py`。
> 它会清空当前数据并重新生成：3 个学期（2024 秋、2025 春、2025-2026 春当前学期）、
> 4 个院系、12 名教师、80 名学生、67 门课程、约 780 条选课记录、约 300 条教学进度。
> 历史学期成绩全部录入；当前学期约 50% 已录入，便于体验「待录入」状态与统计图表。
...
| 学生（精简数据） | 20240001-20240020 | 123456 | `init_db.py` 生成，20 人 |
| 教师（精简数据） | T0001-T0005 | 123456 | `init_db.py` 生成，5 人 |
| 学生（完整数据） | 20230001-20230xxx / 20240001-20240xxx / 20250001-20250xxx | 123456 | `seed_full_demo.py` 生成，80 人，分大三/大二/大一三个年级 |
| 教师（完整数据） | T0001-T0012 | 123456 | `seed_full_demo.py` 生成，12 人，分布于 4 个院系 |
